...
public class ProcessImportDataServlet extends HttpServlet {
    ...
    private static String importWeather(List sheetData, HttpServletRequest request) {
            ...
            if (i>0) {
	            ...
	            for (int j = 0; j < list.size(); j++) {
	                ...
	                if (j==0) {
	                	...
	                	String values = "\'" + location + "\',\'" + month + "\'," + temp + ",\'" + country + "\'";
    ...
    private static String importEmission(List sheetData, HttpServletRequest request) {
        ...
        for (int i = 0; i < sheetData.size(); i++) {
            ...
            if (i>0) {
	            ...
	            String values = "\'" + country + "\',\'" + type + "\',\'" + unit + "\'," + temp;
