...
public class SQLManager {
	...
	/*
	 * static { //CREATION OF QUESTIONNAIRE TABLE (data from SiteInfo and
	 * SiteUsage) String tableName = "QUESTIONNAIRE"; ArrayList<String> fields =
	 * new ArrayList<String>();
	 * 
	 * fields.add("questionnaire_id varchar(255)");
	 * fields.add("site_id varchar(255)"); fields.add("year varchar(255)");
	 ...
	 * 
	 * String primaryKey = "questionnaire_id"; SQLManager.createTable(tableName,
	 * fields, primaryKey); System.out.println("Created table " + tableName);
	 * 
	 * /*CREATION OF SITE TABLE (data from SiteInfo) tableName = "SITE"; fields
	 * = new ArrayList<String>();
	 * 
	 * fields.add("Questionnaire_ID varchar(255)");
	 * fields.add("site_info_ext_area_illuminated varchar(255)");
	 ...
	 * fields.add("usage_electricity_use varchar(255)");
	 * 
	 * primaryKey = "questionnaire_id"; SQLManager.createTable(tableName,
	 * fields, primaryKey); System.out.println("Created table " + tableName);
	 * 
	 * 
	 * //Creation of the GROUND_TO_ROOF_FORM table tableName =
	 * "GROUND_TO_ROOF_FORM"; fields = new ArrayList<String>();
	 * 
	 * fields.add("questionnaire_id varchar(255)");
	 * fields.add("zone_id varchar(255)");
	 * fields.add("building_num varchar(255)");
	 * fields.add("zone_num varchar(255)");
	 * fields.add("building_name char(255)"); fields.add("zone_name char(255)");
	 ...
	 * 
	 * primaryKey = "zone_id"; SQLManager.createTable(tableName, fields,
	 * primaryKey); System.out.println("Created table " + tableName);
	 * 
	 * //Creation of the OFFICE_FORM table tableName = "OFFICE_FORM"; fields =
	 * new ArrayList<String>();
	 * 
	 * fields.add("questionnaire_id varchar(255)");
	 * fields.add("zone_id varchar(255)");
	 ...
	 * primaryKey); System.out.println("Created table " + tableName);
	 * 
	 * //Creation of the WAREHOUSE_VALUE_ADD_FORM table tableName =
	 * "WAREHOUSE_VALUE_ADD_FORM"; fields = new ArrayList<String>();
	 * 
	 * fields.add("questionnaire_id varchar(255)");
	 * fields.add("zone_id varchar(255)");
	 * fields.add("building_num varchar(255)");
	 ...
	 * primaryKey); System.out.println("Created table " + tableName);
	 * 
	 * //Creation of the MEZZANINE_FORM table tableName = "MEZZANINE_FORM";
	 ...
	 * primaryKey); System.out.println("Created table " + tableName);
	 * 
	 * //Creation of the SITE_DEFINITION table tableName = "SITE_DEFINITION";
	 * fields = new ArrayList<String>();
	 * 
	 * fields.add("questionnaire_id varchar(255)");
	 ...
	 * fields, primaryKey); System.out.println("Created table " + tableName);
	 * 
	 * //Creation of the QUESTIONNAIRE_LINK table tableName =
	 * "QUESTIONNAIRE_LINK"; fields = new ArrayList<String>();
	 * 
	 * fields.add("questionnaire_id varchar(255)");
	 * fields.add("questionnaire_link varchar(255)");
	 * fields.add("link_timestamp varchar(255)");
	 * 
	 * primaryKey = "questionnaire_link"; SQLManager.createTable(tableName,
	 * fields, primaryKey); System.out.println("Created table " + tableName); }
	 */

	/*
	 * Creates a table in the database � tableName � the name of the table
	 * � fields � ArrayList of Strings of field details. Each String
	 * corresponds to one field�s name and data type � primaryKey �
	 * primary key of the table
	 */
	public static void createTable(String tableName, ArrayList<String> fields,
			String primaryKey) {
	...
	/*
	 * Deletes a table from the database � tableName � the name of the table
	 */
	...
	/*
	 * Inserts multiple records into a table � tableName � the name of the
	 * table � valuesList � ArrayList of Strings of values. Each String
	 * corresponds to one record�s values
	 */
	...
	/*
	 * Inserts a single record into a table � tableName � the name of the
	 * table � values � the record�s values
	 */
	...
	public static void insertImage(File imgfile, InputStream fin) {
		...
		try {
			...
			PreparedStatement pre = conn
					.prepareStatement("insert into pic values(?,?,?)");
	...
	/*
	 * Retrieves all from the table � tableName � the name of the table �
	...
	public static RetrievedObject retrieveAll(String tableName) {
		 ...
		 * finally { ConnectionManager.close(conn, stmt, rs); }
		 */
	 ...
	 * tableName � the name of the table � whereClause � the condition
	 * that is to be met for retrieval � returns an instance of
	 * java.sql.ResultSet
	 */
	public static RetrievedObject retrieveRecords(String tableName,
			String whereClause) {
	 ...
	 * � tableName � the name of the table � toSet � the variable to be
	...
	/*
	 * Updates the value of the specified variable of specific records in the
	 * table � tableName � the name of the table � toSet � the variable
	 * to be set & the value to set to � whereClause � the condition that is
	 * to be met for updating
	 */
	public static void updateRecords(String tableName, String toSet,
			String whereClause) {
	...
	/*
	 * Deletes all records from the table � tableName � the name of the
	 * table
	 */
	...
	/*
	 * Deletes specific records from the table � tableName � the name of the
	 * table � whereClause � the condition that is to be met for retrieval
	 */
