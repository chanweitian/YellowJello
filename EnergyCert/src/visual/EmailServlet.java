...
public class EmailServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		final String link = "http://apps.greentransformationlab.com/EnergyCert/visual/calculate?quest_id="+quest_id;
		...
		try {
			...
			message.setText("Hi,"
				+ "\n\n Click here to view the Visual Output:  http://apps.greentransformationlab.com/EnergyCert/visual/calculate?quest_id="+quest_id+"&link=" + uuid
				+ "\n\n Thank you.");
